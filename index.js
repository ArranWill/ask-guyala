...
function displayPageBody() {
    document.getElementById("information-container").style.height = document.getElementById("information-inner").clientHeight + "px";  // This allows the information-container to transition size in a nice way.
    if (is_first_query) {
        fadeInElements();
...
function fadeInElements() {
    const elements_to_fade_in = ["organic-light", "recycling-light", "waste-light", "transfer-station-light", "specialist-recycler-light", "information-container", "reminder-container", "acknowledgement-container"];
